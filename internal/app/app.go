...
func initUseCases(cfg *config.Config, pg *postgres.Postgres, jwtManager *jwt.Manager, l logger.Interface) useCases {
	...
	inferenceUC, err := inference.New(
		...
		inference.Options{
			...
			PrimaryPriceVersion:        cfg.Inference.SumoPodPriceVersion,
			PrimaryInputUSDPerMillion:  cfg.Inference.SumoPodInputUSDPerMillion,
			PrimaryCachedUSDPerMillion: cfg.Inference.SumoPodCachedInputUSDPerMillion,
			PrimaryOutputUSDPerMillion: cfg.Inference.SumoPodOutputUSDPerMillion,
			DisableSecondary:           !cfg.Inference.SecondaryEnabled,
